...
export function PliseForm({ product, classesDescription, onClose }: { product: TransformedVariableProduct; classesDescription: Record<string, string>; onClose: () => void; SYSTEM_CLASSES:SystemClasses[]; PRODUCT_TYPES: string[] }) {
  ...
  const {
    ...
    currentVariation,
    finalPrice
  } = usePliseCalculator(product.variations, classesDescription );
