...
"""
Частина бібліотеки woocommerce, яка є обгорткою над бібліотекою request.
На жаль, бібліотека розрахована на синхронні запити.
Тому в своєму коді використовую лише цей код для підпису. 
"""
...
class OAuth(object):
    ...
    def generate_oauth_signature(self, params, url):
        ...
        print("URL:", url)
        print("BASE URI:", base_request_uri)
